  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-6 gap-8">
      <div className="text-center max-w-lg">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">录音测试</h2>
      ...
      <div className="w-full max-w-md flex flex-col items-center gap-6">
        ...
        <div className="w-full p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium text-gray-700 dark:text-gray-300">选择录音设备:</label>
            <select
        ...
        <div className="w-full p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
              <div className="text-sm font-medium text-gray-700 dark:text-gray-300">录音内容:</div>
              <span className="text-sm text-gray-500 dark:text-gray-400">{audioUrl ? "已录制音频" : "请开始录音"}</span>
            </div>
