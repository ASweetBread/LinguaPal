        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-500 dark:text-gray-400">AI语言学习助手</span>
            </div>
            ...
            <nav className="flex items-center gap-6">
              ...
              {/* 用户名显示 */}
              {username && <span className="ml-auto text-gray-700 dark:text-gray-200 font-medium">{username}</span>}
            </nav>
          </div>
        </div>
      </header>
