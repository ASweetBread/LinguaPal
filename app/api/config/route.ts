...
export async function POST(request: NextRequest) {
  try {
    ...
    const { userId, mode, aiTextService, aiAsrService, aiTtsService, dialogueNewWordRatio, dialogueFamiliarWordLevel } =
      body;
    ...
    const statusCode = errorMessage === "配置已存在" ? 409 : errorMessage === "缺少必要参数" ? 400 : 500;
