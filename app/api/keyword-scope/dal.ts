...
export class KeywordScopeDAL {
  // 创建新的关键字范围
  static async createKeywordScope(params: { keywordId: number; scope: string }) {
  ...
  // 批量创建关键字范围
  static async createKeywordScopes(params: { keywordId: number; scopes: string[] }) {
  ...
  // 获取关键字的所有范围
  static async getKeywordScopes(params: { keywordId: number }) {
  ...
  // 更新关键字的范围索引
  static async updateKeywordScopesIndex(params: { keywordId: number; index: number }) {
  ...
  // 获取关键字的范围索引
  static async getKeywordScopesIndex(params: { keywordId: number }) {
    const { keywordId } = params;
